...
import { Drawer, FormField } from '../../../../shared';
import { PAYMENT_API_URL, TATTOO_CONSENT_FORM_API_URL, PIERCING_CONSENT_FORM_API_URL } from '../../../../shared/api';
import { fetchApi } from '../../../../shared/utils/fetch';
import { handleCustomerLookupForForm } from '../../../../shared/utils/consentFormOperations';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!customerId && phone) {
        ...
        customerId = await handleCustomerLookupForForm({ phone }, setError);
        if (!customerId) {
